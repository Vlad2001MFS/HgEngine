...
#define HG_REGISTER_OBJECT(type) HD_RUN_BEFORE_MAIN() { hg::Factory::get().registerObject<type>(); }
...
#define HG_OBJECT(typeName, baseTypeName) \
    public: \
        ...
        static const hg::TypeInfo *getTypeInfoStatic() { static const hg::TypeInfo typeInfoStatic(#typeName, BaseClassName::getTypeInfoStatic()); return &typeInfoStatic; } \
